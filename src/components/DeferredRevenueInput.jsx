...
export default function DeferredRevenueInput({ settings, onSave, saving }) {
  ...
  return (
    <form onSubmit={submit} style={{ padding: 16, marginBottom: 16, border: '1px solid #dedbd3', borderRadius: 8, background: '#fff' }}>
      <div style={{ fontWeight: 700, marginBottom: 6 }}>2025 deferred revenue assumption <span style={{ fontWeight: 400, color: '#77746f' }}>(optional)</span></div>
      ...
      {entries.length > 0 ? (
        <div style={{ marginBottom: 16 }}>
          ...
          {entries.map(([key, amount]) => (
            <div key={key} style={{ display: 'flex', alignItems: 'center', flexWrap: 'wrap', gap: 12, padding: '8px 0', borderBottom: '1px solid #dedbd3', fontSize: 13 }}>
      ...
      ) : <p style={{ fontSize: 12, color: '#77746f' }}>No deferred revenue entries saved.</p>}
