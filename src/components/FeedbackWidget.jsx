...
const S = {
  fab: {
    ...
    background: 'var(--ui-accent, #d84a17)', color: '#fff', border: 'none',
  ...
  panel: {
    ...
    width: 340, background: '#fff', border: '1px solid var(--ui-border, #dedbd3)',
    borderRadius: 8, padding: 18,
    boxShadow: '0 10px 40px rgba(0,0,0,0.5)',
    fontFamily: 'inherit',
  },
  title: { fontSize: 12, color: 'var(--ui-ink, #171717)', letterSpacing: 2, textTransform: 'uppercase', marginBottom: 10, fontWeight: 600 },
  hint: { fontSize: 10, color: 'var(--ui-muted, #77746f)', marginBottom: 12, lineHeight: 1.5 },
  ...
  textarea: {
    ...
    background: 'var(--ui-soft, #f4f1ea)', border: '1px solid var(--ui-border, #dedbd3)', color: 'var(--ui-ink, #171717)',
    borderRadius: 4, outline: 'none', fontFamily: 'inherit', resize: 'vertical',
    boxSizing: 'border-box',
  },
  submit: {
    width: '100%', marginTop: 10, padding: '10px 14px',
    background: 'var(--ui-accent, #d84a17)', color: '#fff', border: 'none', borderRadius: 4,
    fontSize: 11, letterSpacing: 2, textTransform: 'uppercase', cursor: 'pointer',
    fontFamily: 'inherit', fontWeight: 600,
  },
  submitDisabled: { opacity: 0.5, cursor: 'not-allowed' },
  status: { fontSize: 10, color: 'var(--ui-muted, #77746f)', marginTop: 8, lineHeight: 1.5 },
  error: { fontSize: 10, color: '#b42318', marginTop: 8, lineHeight: 1.5 },
  closeX: {
    position: 'absolute', top: 10, right: 10, background: 'none', border: 'none',
    color: 'var(--ui-subtle, #88857f)', fontSize: 18, cursor: 'pointer', padding: 0, lineHeight: 1,
  },
};
