...
const S = {
  fab: {
    ...
    background: '#DC440A', color: '#fff', border: 'none',
  ...
  panel: {
    ...
    width: 340, background: '#161b22', border: '1px solid #2a3441',
    borderRadius: 8, padding: 18,
    boxShadow: '0 10px 40px rgba(0,0,0,0.5)',
    fontFamily: 'inherit',
  },
  title: { fontSize: 12, color: '#f0f4f8', letterSpacing: 2, textTransform: 'uppercase', marginBottom: 10, fontWeight: 600 },
  hint: { fontSize: 10, color: '#8b949e', marginBottom: 12, lineHeight: 1.5 },
  ...
  submit: {
    ...
    background: '#DC440A', color: '#fff', border: 'none', borderRadius: 4,
    fontSize: 11, letterSpacing: 2, textTransform: 'uppercase', cursor: 'pointer',
    fontFamily: 'inherit', fontWeight: 600,
  },
  submitDisabled: { opacity: 0.5, cursor: 'not-allowed' },
  status: { fontSize: 10, color: '#8b949e', marginTop: 8, lineHeight: 1.5 },
  error: { fontSize: 10, color: '#f85149', marginTop: 8, lineHeight: 1.5 },
  closeX: {
    position: 'absolute', top: 10, right: 10, background: 'none', border: 'none',
    color: '#6e7681', fontSize: 18, cursor: 'pointer', padding: 0, lineHeight: 1,
  },
};
    ...
    <>
      ...
      {open && (
        <div style={S.panel}>
          ...
          {done ? (
            <>
              <div style={{ ...S.status, color: '#3fb950' }}>Got it. Thanks.</div>
