...
test('email receipt replay is creator-bound and local records roll back together',async()=>{
 ...
 try{
  ...
  const req={method:'POST',headers:{},body:{creator_id:creators[0].id,to:'one@example.test',subject:'Fixture',body:'Fixture body',request_key:'email-fixture'}};
  ...
  missingReceipt=true;const noReceiptReq={...req,body:{...req.body,request_key:'missing-receipt'}};
