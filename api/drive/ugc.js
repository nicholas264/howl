...
async function getAccessToken() {
  ...
  const audience = process.env.GCP_WIF_AUDIENCE; // //iam.googleapis.com/projects/{num}/locations/global/workloadIdentityPools/{pool}/providers/{provider}
  ...
  // Exchange Vercel OIDC token for a GCP federated access token.
  // Form-urlencoded + snake_case keys per OAuth 2.0 Token Exchange (RFC 8693).
  ...
  // Impersonate the service account to get a usable access token with Drive scope
