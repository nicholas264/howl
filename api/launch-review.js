...
export default async function handler(req,res) {
  ...
  try{
    ...
    const resolved=req.body.new_adset?await resolveNewAdset(req.body.new_adset):null;
    const newAdset=resolved?.request || null;
    ...
    return res.json({approvals,approval_hash:digest(approvals),media:checked,adset,new_adset:newAdset,campaign:resolved?.campaign,creative_test:creativeTest,
