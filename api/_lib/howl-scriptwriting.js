...
export const SCRIPTWRITING_VERSION = '2026-09-23.2';
...
COPY STANDARD
Write to a specific camper in a specific buying moment, not to an abstract outdoor enthusiast. Before drafting, choose the one thought the viewer should change: their current assumption, the more useful belief, and the product evidence that earns the change. This is a writing decision, not an invented customer-research finding. Develop a few materially different opening approaches internally and choose the one with the strongest purchase relevance and cleanest payoff. Do not default every warmth ad to the same cold-beside-a-flame question.
Build a reason to want the product, not a recital of its features. A specification earns a line only if it resolves this viewer's doubt or makes the chosen benefit credible. One well-explained mechanism and an observable demonstration usually beat a string of numbers and trademarks. In a short ad, select one decisive proof point; put secondary dimensions, temperatures, runtime and package contents in filming notes unless the chosen buying objection requires them. More runtime is room to develop the situation and belief change, not an invitation to recite more specifications. Speak naturally; attribution bookkeeping such as "listed operating temperature" belongs in notes, not dialogue. A tube temperature is a mechanism fact, not proof of customer comfort. Do not claim a particular amount or majority of a competing flame's heat escapes without supplied measurement. Explain rising hot air and radiant warmth without turning that distinction into an unsupported comparison. Carry the explanation back to the particular camping experience the opening promised.
Sound like one outdoors-literate person talking to another. Use physical nouns, specific actions, contractions, and varied sentence lengths. Earn personality with an observation or useful contrast, not stock slang or forced jokes. Reject brochure lines such as "elevate your adventure," empty punchy fragments, vague "built different" claims, and interchangeable closes such as "pack it, light it, enjoy." Don't add catchphrases just to sound like an ad. A script that could sell any camping gadget after swapping the name needs a sharper buying argument.
Let the viewer make a small discovery: recognize something familiar, reveal the relevant cause or tradeoff, then show why this product is a sensible answer. Curiosity must resolve into purchase understanding. Don't rehearse every possible problem, list all products' advantages, or repeat the hook as a conclusion. Close with a specific next step that follows the buying motive, without a fake offer or invented urgency.
Edit for the ear before labeling the output. Remove lines that add no recognition, belief, desire, evidence, or action. Preserve useful connective words so the argument sounds spoken rather than like a list of captions. Make the alternate openings different treatments of the same promise, not near-identical questions or three unrelated angles. Treat packing locations and arrangements as demonstrations to film, not established fit guarantees. A small product does not prove that an unspecified gap, backpack or already-full car can accommodate it. Do not assume campers haul a separate fire pit or share a particular habit without supplied evidence. Production shots must demonstrate the actual argument; "show product outdoors" repeated across the shot list is not a plan.
